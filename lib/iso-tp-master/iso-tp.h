...
/* Timeout values */
// #define TIMEOUT_SESSION  20000 /* Timeout between successfull send and receive */
#define TIMEOUT_FC       1000 /* Timeout between FF and FC or Block CF and FC */
#define TIMEOUT_CF       1000 /* Timeout between CFs                          */
#define MAX_FCWAIT_FRAME  10000

#define MAX_MSGBUF 175000    /* Received Message Buffer. Depends on uC ressources!
...
class IsoTp
{
  public:
    ...
    void    print_buffer(INT32U id, uint8_t *buffer, uint32_t len);
  private:
    MCP_CAN* _bus;
    uint8_t  _mcp_int;
    INT32U   rxId;
